...
export const uploadImage = async (file: File, bucket: string = 'thumbnails'): Promise<string> => {
...
export const deleteImage = async (url: string, bucket: string = 'thumbnails'): Promise<void> => {
  try {
